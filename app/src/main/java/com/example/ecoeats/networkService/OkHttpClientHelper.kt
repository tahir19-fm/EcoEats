package com.example.ecoeats.networkService
...
import com.example.ecoeats.BuildConfig
import com.example.ecoeats.EcoEatsApp
import okhttp3.*
...
class OkHttpClientHelper {
    ...
    fun getOkHttpClient(): OkHttpClient {
        val httpCacheDirectory = File(EcoEatsApp.instance?.cacheDir, "http-cache")
    ...
    private fun getChuckerInterceptor(): ChuckerInterceptor? {
        val context = EcoEatsApp.instance?.baseContext
        return context?.let {
